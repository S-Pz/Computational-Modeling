...
def odeSystem_SIRS(t,u, beta, alpha, gamma):
...
def solve(x):
    ...
    def solveOde(t, y):
        return odeSystem_SIRS(t, y, *params)
...
if __name__ == "__main__":
    ...
    u = [S0, I0, R0]
    result_best = solve_ivp(odeSystem_SIRS,(0, tfinal+dt), u, t_eval=times, args=best, method='RK45')
